...
select * from countrylanguage where IsOfficial = 'T' and Percentage between 80 and 90 order by Percentage desc ;
...
select Name,count(*) as Countofcount from country where Name like 'I%A';
